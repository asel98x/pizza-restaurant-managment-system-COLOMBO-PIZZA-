...
public class skip_pizza_list_adapter extends BaseAdapter {
    Context context;
    ArrayList<DB_pizza> pizza;
    TextView lblName, lblPrice,number;
    ImageView imageView;

    public skip_pizza_list_adapter(Context context, ArrayList<DB_pizza> pizza) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = inflater.inflate(R.layout.custom_skip_pizza,parent,false);
