...
public class apprtizer_list_adapter extends BaseAdapter {
    Context context;
    ...
    public apprtizer_list_adapter(Context context, ArrayList<DB_apprtizer> apprtizer) {
