 ...
 * Use the {@link frg_pizza#newInstance} factory method to
 * create an instance of this fragment.
 */
public class frg_pizza extends Fragment {
     ...
     * @return A new instance of fragment frg_pizza.
     */
    // TODO: Rename and change types and number of parameters
    public static frg_pizza newInstance(String param1, String param2) {
        frg_pizza fragment = new frg_pizza();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frg_pizza, container, false);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!txtID.getText().toString().isEmpty() && !txtName.getText().toString().isEmpty() && !txtdescription.getText().toString().isEmpty() && !TxtPrice.getText().toString().isEmpty()){
                    ...
                    pizza.setF_id(id);
                    pizza.setF_name(name);
                    pizza.setF_description(description);
                    pizza.setF_price(price);
                    pizza.setImg(imageByte);


                    try {
                        db = new DB_operation(getActivity());
                        if (db.insertPizza_img(pizza) > 0) {
                            Toast.makeText(getActivity(), "New Pizza item Interested!", Toast.LENGTH_SHORT).show();
                            clear_pizza();
                        }
                    }catch (Exception e){
        ...
        find.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!txtID.getText().toString().isEmpty()){
                    ...
                    DB_pizza pizza = new DB_pizza();
                    pizza.setF_id(id);
                    pizza = db.findPizza_item(pizza);

                    try {

                        if (pizza!= null) {
                            txtName.setText(pizza.getF_name());
                            txtdescription.setText(pizza.getF_description());
                            TxtPrice.setText("" + pizza.getF_price());
                            Bitmap bitmap = BitmapFactory.decodeByteArray(pizza.getImg(),0,pizza.getImg().length);
                            image.setImageBitmap(bitmap);

                        } else {
                            Toast.makeText(getActivity(), "Can not Find the pizza item", Toast.LENGTH_SHORT).show();
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!txtID.getText().toString().isEmpty()){
                    ...
                    pizza.setF_id(ID);
                    pizza.setF_name(txtName.getText().toString());
                    pizza.setF_description(txtdescription.getText().toString());
                    pizza.setF_price(Double.parseDouble(TxtPrice.getText().toString()));
                    pizza.setImg(imageByte);

                    db.update_pizza_item(pizza);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!txtID.getText().toString().isEmpty()){
                    ...
                    DB_pizza product = new DB_pizza();
                    product.setF_id(ID);

                    if(db.delte_pizza_item(product)>0){
                        Toast.makeText(getActivity(),"Pizza item Deleted", Toast.LENGTH_SHORT).show();
                        clear_pizza();
                    }
                }else{
                    Toast.makeText(getActivity(),"Can't find the pizza item!", Toast.LENGTH_SHORT).show();
                }
