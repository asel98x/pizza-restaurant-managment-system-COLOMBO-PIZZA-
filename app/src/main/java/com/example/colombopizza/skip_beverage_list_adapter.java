...
public class skip_beverage_list_adapter extends BaseAdapter {
    Context context;
    ArrayList<DB_beverage> beverage;
    TextView lblName, lblPrice;
    ImageView imageView;

    public skip_beverage_list_adapter(Context context, ArrayList<DB_beverage> beverage) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = inflater.inflate(R.layout.custom_skip_beverage,parent,false);
